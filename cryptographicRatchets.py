...
The_First_Sensor = True
The_Second_Sensor = False

SALTS = {'RK': b'\x00',
         'HK': {The_First_Sensor: b'\x01', The_Second_Sensor: b'\x02'},
         'NHK': {The_First_Sensor: b'\x03', The_Second_Sensor: b'\x04'},
         'CK': {The_First_Sensor: b'\x05', The_Second_Sensor: b'\x06'},
         'CONVid': b'\x07'}
...
class Axolotl(object):
    ...
    def init_conversation(self, other_name,
        ...
        if mode is None:
            if identity_key < other_identity_key:
                mode = The_First_Sensor
            else:
                mode = The_Second_Sensor
    ...
    def create_conversation(self, other_name, mkey, mode,
        ...
        if mode is The_First_Sensor:
            HKs = None
            HKr = kdf(mkey, SALTS['HK'][The_Second_Sensor])
            CKs = None
            CKr = kdf(mkey, SALTS['CK'][The_Second_Sensor])
            DHRs_priv = None
            DHRs = None
...
class AxolotlConversation:
    ...
    def print_state(self):
        ...
        if self.mode is The_First_Sensor:
            print 'Mode: The_First_Sensor'
        else:
            print 'Mode: The_Second_Sensor'
...
def generate_3dh(a, a0, b, b0, mode=The_First_Sensor):
    if mode is The_First_Sensor:
